  ...
  corners: [
    {
      ...
      desc: 'The highest-return corner in the game and the one Top-50 players still concede. You attack the near post with your tallest body, flick it across the six-yard box, and Cahill arrives unmarked at the back post because every defender has already stepped toward the first contact.',
      ...
      coach: [
        ...
        [500,  'Acerbi attacks the near post <b>early</b>. He is not scoring — he is a deflector.'],
        [1500, 'Contact. <b>Flick it across</b> the six-yard box — a glance, not a smash.'],
        [2100, 'Cahill has held his run at the edge of the six and now steps in <b>behind</b> the far-post defender.'],
        [2600, '<b>Header, goal.</b> Nobody picked him up because everybody followed the first ball.']
      ],
      actors: [
        { id: 'AZK', x: 38,  y: 34 },
        { id: 'ACE', x: 250, y: 130 }, { id: 'CAH', x: 445, y: 130 },
        { id: 'R9',  x: 340, y: 105 }, { id: 'MCK', x: 340, y: 215 },
        { id: 'D1', x: 306, y: 60 }, { id: 'D2', x: 352, y: 92 }, { id: 'D3', x: 400, y: 96 },
        { id: 'D4', x: 268, y: 108 }, { id: 'D5', x: 340, y: 26 }
      ],
      ball: { holder: 'AZK' },
      steps: [
        { type: 'run',  actor: 'ACE', t0: 500,  t1: 1500, to: { x: 300, y: 52 } },
        { type: 'run',  actor: 'D1',  t0: 700,  t1: 1500, to: { x: 288, y: 44 } },
        { type: 'run',  actor: 'R9',  t0: 700,  t1: 1600, to: { x: 320, y: 72 } },
        { type: 'pass', from: 'AZK',  t0: 700,  t1: 1550, to: { x: 302, y: 50 }, cross: true },
        { type: 'flash', t0: 1500, at: { x: 302, y: 50 }, label: 'FLICK' },
        { type: 'run',  actor: 'CAH', t0: 1400, t1: 2400, to: { x: 396, y: 54 } },
        { type: 'run',  actor: 'D3',  t0: 1700, t1: 2400, to: { x: 372, y: 74 } },
        { type: 'pass', from: 'ACE',  t0: 1600, t1: 2350, to: { x: 394, y: 52 }, cross: true },
        { type: 'shot', from: 'CAH',  t0: 2500, t1: 2800, to: { x: 336, y: 8 } },
        { type: 'goal', t0: 2800 }
      ],
      dur: 3600, view: 'box'
    },
    {
      ...
      why: 'Aerial duels are close to 50/50 even with Cahill. A cutback from the byline is the single highest expected-goals action in the game. Short corners convert one into the other.',
      coach: [
        [0,    'Nine defenders in the box. A floated ball here is a lottery ticket. <b>[X] short</b> instead.'],
        [700,  'Timber steps to receive. Now it is <b>2v1</b> in the corner and two defenders must leave the box.'],
        [1500, 'Return pass, Azkona faces the byline with the man beaten.'],
        [2400, 'Not a cross — <b>low cutback</b> to the penalty spot. The two who came out cannot get back.'],
        [3000, 'Cahill arrives late onto the pull-back. <b>[SQ] first time.</b>']
      ],
      actors: [
        { id: 'AZK', x: 38,  y: 36 }, { id: 'TIM', x: 104, y: 112 },
        { id: 'CAH', x: 400, y: 215 }, { id: 'R9', x: 330, y: 96 }, { id: 'SAN', x: 470, y: 175 },
        { id: 'D1', x: 300, y: 56 }, { id: 'D2', x: 352, y: 62 }, { id: 'D3', x: 396, y: 100 },
        { id: 'D4', x: 262, y: 104 }, { id: 'D5', x: 340, y: 26 }
      ],
      ball: { holder: 'AZK' },
      steps: [
        { type: 'pass', from: 'AZK', t0: 500, t1: 1000, to: 'TIM' },
        { type: 'run',  actor: 'D4', t0: 900, t1: 2000, to: { x: 150, y: 118 } },
        { type: 'run',  actor: 'D1', t0: 1100, t1: 2100, to: { x: 216, y: 96 } },
        { type: 'run',  actor: 'AZK', t0: 1000, t1: 1900, to: { x: 94, y: 54 } },
        { type: 'pass', from: 'TIM', t0: 1500, t1: 2000, to: 'AZK' },
        { type: 'carry', actor: 'AZK', t0: 2000, t1: 2600, to: { x: 136, y: 42 }, withBall: true },
        { type: 'flash', t0: 2200, at: { x: 190, y: 108 }, label: '2 OUT' },
        { type: 'run',  actor: 'CAH', t0: 2100, t1: 3200, to: { x: 336, y: 112 } },
        { type: 'pass', from: 'AZK', t0: 2600, t1: 3200, to: { x: 334, y: 110 }, driven: true },
        { type: 'shot', from: 'CAH', t0: 3300, t1: 3600, to: { x: 372, y: 8 } },
        { type: 'goal', t0: 3600 }
      ],
      dur: 4400, view: 'box'
    },
    {
      ...
      desc: 'Most goals conceded from corners are conceded before the ball is struck. Set your shape, take manual control of the one player who covers the danger zone, and leave R9 on the halfway line so every clearance is a counter-attack rather than a second corner.',
      ...
      coach: [
        [0,    'Before the kick: control <b>Rice</b> and stand him at the <b>edge of the box</b>. That is the rebound and cutback zone the AI abandons.'],
        [800,  'Leave <b>R9 on the halfway line</b>. One man up costs you nothing in the box and gives you an outlet.'],
        [1600, 'Delivery comes in. Do not swing early — let Acerbi and the keeper attack the first ball.'],
        [2400, 'Cleared to the edge. Rice is <b>already there</b>. That is the whole trick.'],
        [3000, 'Head up immediately: <b>[TR] to R9</b>. They committed eight players. You are 3v2 going the other way.']
      ],
      actors: [
        { id: 'ACE',  x: 306, y: 56 }, { id: 'MARQ', x: 356, y: 62 },
        { id: 'TIM',  x: 272, y: 42 }, { id: 'CAH', x: 400, y: 74 },
        { id: 'RICE', x: 340, y: 176 }, { id: 'R9', x: 380, y: 520 },
      ...
      steps: [
        ...
        { type: 'run',  actor: 'ACE', t0: 1700, t1: 2300, to: { x: 328, y: 68 } },
        { type: 'pass', from: 'ACE', t0: 2400, t1: 2950, to: { x: 340, y: 172 }, cross: true },
        { type: 'run',  actor: 'R9', t0: 2900, t1: 4200, to: { x: 420, y: 330 } },
        { type: 'pass', from: 'RICE', t0: 3100, t1: 4000, to: { x: 418, y: 336 }, driven: true },
  ...
  freeKicks: [
    {
      ...
      actors: [
        { id: 'SAN', x: 316, y: 236 }, { id: 'CAH', x: 372, y: 240 },
      ...
      steps: [
        ...
        { type: 'shot', from: 'SAN', t0: 2000, t1: 2900, to: { x: 304, y: 12 }, cross: true },
        { type: 'goal', t0: 2900 }
      ],
      dur: 3800, view: 'box'
    },
    {
      ...
      actors: [
        { id: 'SAN', x: 330, y: 320 }, { id: 'MCK', x: 384, y: 322 },
      ...
      steps: [
        ...
        { type: 'shot', from: 'SAN', t0: 2100, t1: 2850, to: { x: 380, y: 14 }, driven: true },
        { type: 'goal', t0: 2850 }
      ],
      dur: 3700, view: 'box'
    },
    {
      ...
      desc: 'A wide free kick is a corner you get to take with a running start and no crowd on the ball. Whip it hard beyond the far post so it moves away from the keeper, and let Cahill run onto it.',
      ...
      coach: [
        ...
        [1500, 'Cahill starts from <b>outside</b> the six and attacks the ball moving forward. Never wait in the zone.'],
        [2400, 'Marquinhos occupies the near post and takes his marker with him.'],
        [3000, '<b>Header down and in.</b>']
      ],
      actors: [
        { id: 'AZK',  x: 128, y: 268 },
        { id: 'CAH',  x: 424, y: 168 }, { id: 'MARQ', x: 300, y: 120 }, { id: 'R9', x: 350, y: 130 },
        { id: 'D1', x: 292, y: 88 }, { id: 'D2', x: 344, y: 92 }, { id: 'D3', x: 396, y: 116 },
        { id: 'D4', x: 258, y: 116 }, { id: 'D5', x: 340, y: 28 }
      ],
      ball: { holder: 'AZK' },
      steps: [
        { type: 'run',  actor: 'MARQ', t0: 1400, t1: 2400, to: { x: 296, y: 60 } },
        { type: 'run',  actor: 'D1',   t0: 1600, t1: 2400, to: { x: 288, y: 52 } },
        { type: 'run',  actor: 'CAH',  t0: 1500, t1: 2900, to: { x: 400, y: 62 } },
        { type: 'pass', from: 'AZK',   t0: 1600, t1: 2900, to: { x: 402, y: 60 }, cross: true },
        { type: 'shot', from: 'CAH',   t0: 3000, t1: 3350, to: { x: 340, y: 8 } },
        { type: 'goal', t0: 3350 }
      ],
      dur: 4200, view: 'box'
    },
    {
      ...
      actors: [
        { id: 'SAN', x: 340, y: 252 }, { id: 'MCK', x: 392, y: 258 },
        { id: 'D1', x: 316, y: 160 }, { id: 'D2', x: 340, y: 158 }, { id: 'D3', x: 364, y: 158 },
        { id: 'D4', x: 388, y: 160 }, { id: 'D5', x: 336, y: 30 }
      ],
      ball: { holder: 'SAN' },
      steps: [
        { type: 'pass', from: 'SAN', t0: 900, t1: 1500, to: { x: 424, y: 256 } },
        { type: 'run',  actor: 'MCK', t0: 1000, t1: 1700, to: { x: 428, y: 258 } },
        { type: 'flash', t0: 1800, at: { x: 428, y: 200 }, label: 'LANE' },
        { type: 'shot', from: 'MCK', t0: 2300, t1: 3050, to: { x: 300, y: 14 }, driven: true },
        { type: 'goal', t0: 3050 }
      ],
      dur: 3900, view: 'box'
    }
...
DATA.eliteRoutes = [
  {
    ...
    coach: [
      [0,    'McKennie on the right half-space. Their CDM is <b>reading your hips</b> and shading the central lane.'],
      ...
      [2700, 'It bends <b>around</b> the CB into R9 stride.'],
      [3800, 'Clean through. <b>[SQ]</b> across the keeper.']
    ],
    actors: [
      { id: 'MCK', x: 440, y: 610 }, { id: 'R9', x: 400, y: 400 },
      { id: 'CAH', x: 250, y: 500 }, { id: 'AZK', x: 600, y: 480 },
    ...
    steps: [
      ...
      { type: 'run',  actor: 'R9', t0: 1400, t1: 3200, to: { x: 300, y: 170 }, curve: -.16 },
      { type: 'run',  actor: 'D2', t0: 1900, t1: 3000, to: { x: 380, y: 250 } },
      { type: 'pass', from: 'MCK', t0: 1600, t1: 3100, to: { x: 306, y: 186 }, cross: true },
      { type: 'flash', t0: 2400, at: { x: 400, y: 300 }, label: 'BEND' },
      { type: 'carry', actor: 'R9', t0: 3200, t1: 4100, to: { x: 286, y: 74 }, withBall: true },
      { type: 'shot', from: 'R9', t0: 4200, t1: 4550, to: { x: 372, y: 8 } },
      { type: 'goal', t0: 4550 }
    ],
    dur: 5300
  },
  {
    ...
    coach: [
      [0,    'Azkona reaches the byline with the fullback goal-side and square to him.'],
      ...
      [2900, 'Cahill is arriving from deep with no marker. <b>First time.</b>']
    ],
    actors: [
      { id: 'AZK', x: 580, y: 130 }, { id: 'CAH', x: 430, y: 330 },
      { id: 'R9',  x: 360, y: 90 },  { id: 'SAN', x: 250, y: 250 },
    ...
    steps: [
      ...
      { type: 'carry', actor: 'AZK', t0: 1400, t1: 2200, to: { x: 604, y: 62 }, withBall: true },
      { type: 'run',  actor: 'CAH', t0: 1500, t1: 3000, to: { x: 344, y: 116 } },
      { type: 'run',  actor: 'D4',  t0: 2000, t1: 2900, to: { x: 292, y: 108 } },
      { type: 'pass', from: 'AZK', t0: 2300, t1: 2950, to: { x: 342, y: 112 }, driven: true },
      { type: 'shot', from: 'CAH', t0: 3050, t1: 3400, to: { x: 300, y: 8 } },
      { type: 'goal', t0: 3400 }
    ],
    dur: 4200, view: 'box'
  },
  {
    ...
    coach: [
      [0,    'Sanchez has the ball in the left channel with a defender tight to Cahill.'],
      [800,  '<b>[L1] + [X]</b>: pass into Cahill feet and hold the trigger. Sanchez keeps running.'],
      [1700, 'The marker steps to Cahill — he has to, the ball is there.'],
      [2400, '<b>First-time return</b> into the space Sanchez already occupies. Never control it, never turn.'],
      [3200, 'Through the line, into the box, <b>[SQ] across the keeper</b>.']
    ],
    actors: [
      { id: 'SAN', x: 180, y: 560 }, { id: 'CAH', x: 300, y: 430 },
      { id: 'R9',  x: 420, y: 300 }, { id: 'MCK', x: 300, y: 660 },
      { id: 'D1', x: 240, y: 300 }, { id: 'D2', x: 400, y: 300 }, { id: 'D3', x: 300, y: 390 },
      { id: 'D4', x: 130, y: 350 }
    ],
    ball: { holder: 'SAN' },
    steps: [
      { type: 'pass', from: 'SAN', t0: 800, t1: 1500, to: 'CAH' },
      { type: 'run',  actor: 'SAN', t0: 900, t1: 2600, to: { x: 228, y: 330 } },
      { type: 'run',  actor: 'D3',  t0: 1200, t1: 2200, to: { x: 300, y: 410 } },
      { type: 'flash', t0: 1800, at: { x: 300, y: 420 }, label: 'HE STEPS' },
      { type: 'pass', from: 'CAH', t0: 2400, t1: 3000, to: { x: 232, y: 300 } },
      { type: 'carry', actor: 'SAN', t0: 3000, t1: 4000, to: { x: 268, y: 120 }, withBall: true },
      { type: 'shot', from: 'SAN', t0: 4100, t1: 4450, to: { x: 376, y: 8 } },
      { type: 'goal', t0: 4450 }
    ],
    dur: 5200
  },
  {
    ...
    desc: 'Everybody defends the far post because everybody crosses to it. Against a deep block, drive it low and hard to the near post instead and attack it with R9 running across his marker.',
    ...
    coach: [
      ...
      [800,  'Azkona has a yard. Do not float it — <b>ground/low driven</b> to the near post.'],
      [1700, 'R9 attacks <b>across the front</b> of his marker toward the near post.'],
      [2500, 'The CB is turned and facing his own goal. The keeper cannot come.'],
      [3100, 'Any contact scores. <b>Toe it in.</b>']
    ],
    actors: [
      { id: 'AZK', x: 560, y: 200 }, { id: 'R9', x: 400, y: 170 },
      { id: 'CAH', x: 330, y: 250 }, { id: 'SAN', x: 200, y: 190 },
      { id: 'D1', x: 300, y: 90 }, { id: 'D2', x: 366, y: 96 }, { id: 'D3', x: 430, y: 120 },
      { id: 'D4', x: 250, y: 130 }, { id: 'D5', x: 348, y: 28 }
    ],
    ball: { holder: 'AZK' },
    steps: [
      { type: 'run',  actor: 'R9', t0: 1300, t1: 2600, to: { x: 306, y: 62 } },
      { type: 'run',  actor: 'D3', t0: 1600, t1: 2600, to: { x: 352, y: 84 } },
      { type: 'pass', from: 'AZK', t0: 1700, t1: 2700, to: { x: 304, y: 58 }, driven: true },
      { type: 'flash', t0: 2500, at: { x: 304, y: 58 }, label: 'NEAR POST' },
      { type: 'shot', from: 'R9', t0: 3100, t1: 3400, to: { x: 330, y: 8 } },
      { type: 'goal', t0: 3400 }
    ],
    dur: 4200, view: 'box'
  },
  {
    ...
    coach: [
      ...
      [700,  'R9 takes it to the corner flag and shields with <b>[L2]</b>. Back to goal, body between ball and man.'],
      [1600, 'One presses. Then a second. Then the fullback slides over. <b>Their block is now lopsided.</b>'],
      [2600, '<b>Lofted switch</b> to Sanchez. One pass covers what took them ten seconds to shift.'],
      [3600, 'He has the whole flank. Drive at the byline and this becomes a cutback.']
    ],
    actors: [
      { id: 'R9',  x: 620, y: 120 }, { id: 'SAN', x: 90, y: 320 },
      { id: 'CAH', x: 380, y: 260 }, { id: 'MCK', x: 420, y: 430 },
    ...
    steps: [
      ...
      { type: 'run',  actor: 'SAN', t0: 2400, t1: 3600, to: { x: 120, y: 230 } },
      { type: 'pass', from: 'R9', t0: 2600, t1: 3600, to: { x: 122, y: 232 }, cross: true },
      { type: 'carry', actor: 'SAN', t0: 3600, t1: 4600, to: { x: 150, y: 70 }, withBall: true },
  ...
  },
  {
    ...
    coach: [
      [0,    'Rice steps in and wins it. <b>Clock starts now.</b>'],
      [500,  'Do not take a settling touch. Do not look for Marquinhos. <b>Head up, forward.</b>'],
      [1100, '<b>[R2]+[X]</b> driven into Cahill dropping into the vacated middle.'],
      [2100, 'One touch — he never turns, he <b>releases</b>. Their CBs are still recovering.'],
      [2900, 'R9 through the gap the fullback left. Three passes, four seconds, one goal.']
    ],
    actors: [
      { id: 'RICE', x: 330, y: 720 }, { id: 'CAH', x: 350, y: 540 },
      { id: 'R9',   x: 430, y: 420 }, { id: 'SAN', x: 150, y: 500 },
    ...
    steps: [
      ...
      { type: 'pass', from: 'RICE', t0: 1100, t1: 1900, to: 'CAH', driven: true },
      { type: 'run',  actor: 'R9', t0: 1300, t1: 3200, to: { x: 520, y: 180 }, curve: .12 },
      { type: 'run',  actor: 'D2', t0: 2000, t1: 3100, to: { x: 486, y: 244 } },
      { type: 'pass', from: 'CAH', t0: 2100, t1: 3100, to: { x: 522, y: 196 } },
      { type: 'carry', actor: 'R9', t0: 3200, t1: 4100, to: { x: 448, y: 74 }, withBall: true },
      { type: 'shot', from: 'R9', t0: 4200, t1: 4550, to: { x: 316, y: 8 } },
      { type: 'goal', t0: 4550 }
    ],
    dur: 5300, view: 'full'
  },
  {
    ...
    desc: 'Send the cross knowing it may be cleared, and have McKennie already arriving at the edge of the box. Defences collapse toward the ball on every cross and nobody in the game picks up the man attacking the rebound zone.',
    ...
    coach: [
      [0,    'Azkona is going to cross. Before it leaves his foot, <b>send McKennie to the edge of the box</b>.'],
      ...
      [2600, 'It drops to the edge. McKennie is arriving at speed, unmarked.'],
      [3200, '<b>First time, [SQ], low through the crowd.</b> Keepers are unsighted on these.']
    ],
    actors: [
      { id: 'AZK', x: 570, y: 180 }, { id: 'CAH', x: 400, y: 130 }, { id: 'R9', x: 330, y: 110 },
      { id: 'MCK', x: 340, y: 330 },
    ...
    ball: { holder: 'AZK' },
    steps: [
      { type: 'run',  actor: 'MCK', t0: 700, t1: 2600, to: { x: 336, y: 186 } },
      { type: 'pass', from: 'AZK', t0: 900, t1: 1900, to: { x: 372, y: 70 }, cross: true },
      ...
      { type: 'shot', from: 'MCK', t0: 3200, t1: 3650, to: { x: 296, y: 10 }, driven: true },
      { type: 'goal', t0: 3650 }
    ],
    dur: 4500, view: 'box'
  },
  {
    ...
    desc: 'Azkona holds the touchline while Timber runs inside him rather than around him. The fullback has to pick one, and whichever he picks the other one is free — inside for the shot, outside for the byline.',
    ...
    coach: [
      [0,    'Azkona wide right, fullback square to him and comfortable.'],
      [800,  'Timber does not overlap — he runs <b>inside</b>. Trigger it with <b>[L1]</b>.'],
      ...
      [3100, 'Slide it into Timber, byline, pull back. Cahill finishes.']
    ],
    actors: [
      { id: 'AZK', x: 600, y: 330 }, { id: 'TIM', x: 590, y: 480 },
      { id: 'CAH', x: 330, y: 300 }, { id: 'R9', x: 380, y: 190 },
      { id: 'D1', x: 300, y: 180 }, { id: 'D2', x: 420, y: 190 }, { id: 'D3', x: 560, y: 250 },
      { id: 'D4', x: 200, y: 210 }
    ],
    ball: { holder: 'AZK' },
    steps: [
      { type: 'run',  actor: 'TIM', t0: 800, t1: 2600, to: { x: 480, y: 200 }, curve: .1 },
      { type: 'run',  actor: 'D2',  t0: 1800, t1: 2700, to: { x: 470, y: 210 } },
      { type: 'flash', t0: 2400, at: { x: 470, y: 216 }, label: 'CB STEPS' },
      { type: 'pass', from: 'AZK', t0: 2500, t1: 3200, to: { x: 500, y: 130 }, driven: true },
      { type: 'run',  actor: 'TIM', t0: 2600, t1: 3600, to: { x: 520, y: 80 } },
      { type: 'run',  actor: 'CAH', t0: 2400, t1: 3900, to: { x: 344, y: 112 } },
      { type: 'pass', from: 'TIM', t0: 3700, t1: 4300, to: { x: 342, y: 112 }, driven: true },
      { type: 'shot', from: 'CAH', t0: 4400, t1: 4750, to: { x: 386, y: 8 } },
      { type: 'goal', t0: 4750 }
    ],
    dur: 5500, view: 'top'
  }
...
DATA.shapes = [
  {
    ...
    defend: 'Their CAM is the danger. Rice stays glued to him, and never step both CDMs at once.',
  ...
  },
  {
    ...
    space: 'The pocket between their midfield line and back four — exactly where Cahill lives.',
    attack: 'Cahill in the pocket is the whole game plan. Up-back-through repeatedly: their CM has to step to him, and the moment he does the through ball is on. Their two strikers do not track back, so McKennie is free.',
    defend: 'Two strikers means you keep both CBs home always. Do not let Timber get caught upfield.',
    routes: ['Up-Back-and-Through', 'Wall Pass', 'The R9 Runway'],
    spots: [
  ...
  },
  {
    ...
    attack: 'Never play through the middle — that is the trap. Beat the first press with one pass, then switch immediately. Your wingers face fullbacks with zero cover. Byline, cutback, repeat. If they keep pressing, bait them with a CB and split it with McKennie.',
    defend: 'Their striker pair splits your CBs. Rice screens, line at 45, and never send both CDMs to press.',
  ...
  },
  {
    ...
    attack: 'Forget through balls. Three tools only: wide 2v1 to the byline for cutbacks, far-post whipped crosses to Cahill, and the second-ball crash at the edge of the box. Use the corner-flag hold to drag them out. Take your corners short.',
    defend: 'Do not over-commit. Rice never goes past halfway and one CB stays central at all times, because their entire game is the one long ball into the channel.',
  ...
  },
  {
    ...
    attack: 'This is a transition match. Win it and go immediately — the three-second rule is worth more than any pattern here. R9 diagonally into the space their fullback vacated, every single time. In settled play, drag their single CDM one way and play through the other side.',
    defend: 'Their wingers stay wide and high — your fullbacks must not follow them inside. Rice picks up the eight who runs beyond.',
    routes: ['Three-Second Transition', 'The R9 Runway', 'Trivela Channel Ball'],
    spots: [
  ...
  },
  {
    ...
    attack: 'Pin the wingback by keeping Azkona high and wide, then attack the space behind him. Their widest CB has to come across, which drags the back three apart. Trivela or driven through into that channel, then a cutback into the gap the third CB left.',
  ...
  },
  {
    ...
    defend: 'Their two strikers plus two narrow attackers is a four-man counter. Rice never leaves, and you accept slower build-up in exchange for never being 4v3 the other way.',
  ...
  },
  {
    ...
    attack: 'Bait it. Walk the ball with a CB until two players commit, then break the line with one driven pass into McKennie or straight over the top for R9. Use the keeper as a reset button without shame. Every press they lose costs them stamina you get to spend in the 80th minute.',
    defend: 'When they win it high they attack instantly. Rice stays home and you do not counter-press with more than one man.',
    routes: ['The R9 Runway', 'Three-Second Transition', 'Wall Pass'],
    spots: [
...
DATA.matchScripts = [
  {
    ...
    bullets: [
      ...
      'Test the high line once with an early R9 runway. Their reaction tells you whether Route 1 is live all game.',
  ...
  },
  {
    ...
    bullets: [
      'Line Height 60–65, McKennie from Deep-Lying Playmaker to Box Crasher, or switch to the 3-4-2-1 preset.',
...
DATA.reads = [
  { tell: 'They hold second-man press constantly', fix: 'Bait it with a CB, then split the two committed players with one driven pass into McKennie. Their shape will be broken every time they do it.' },
  ...
  { tell: 'They spam pace on one wing', fix: 'Line Height down to 40, keep Timber strictly Fullback/Defend, and let Marquinhos shade that side. Give them the touchline, take away the diagonal.' },
  ...
  { tell: 'Their fullbacks are permanently high', fix: 'The three-second transition is your entire game plan. Win it, go immediately, R9 diagonal into the vacated channel.' },
...
DATA.mechanics = [
  ...
  },
  {
    group: 'Defending', items: [
      ...
      { n: 'Shoulder challenge', pad: '[X]',        d: 'Running alongside. Almost never a foul and your defenders out-muscle most attackers.' },
      { n: 'Stand tackle',      pad: '[O]',         d: 'Tap out of the jockey stance on a trigger. Release the left stick as you press so you do not lunge through.' },
      { n: 'Slide',             pad: '[SQ]',        d: 'Emergencies only. Never inside your own box.' },
      { n: 'Second-man press',  pad: '[R2]',        d: 'One to two second bursts. Held, it drags Rice out and gift-wraps your middle.' },
...
DATA.eliteDrills = [
  ...
  { t: 'Far-post driven crosses, 20 reps', d: 'From both flanks, aimed beyond the far post. Cahill wins those and no fullback in the game beats him in the air.' },
